...
public class HashDiff extends Diff {
	...
	protected Hashtable<IntPair, Association<Integer, String>> hashTable = new Hashtable<IntPair, Association<Integer, String>>();
	...
	*/
	...
	public Association<Integer, String> diffHelper(int remainingFile1Index, int
		 ...
		 * works. */
		IntPair currentPair = new IntPair(remainingFile1Index, remainingFile2Index);
		if (hashTable.containsKey(currentPair)) {
			return hashTable.get(currentPair);
		} else {
		    //$ Good job including a call to super!
		    
			Association<Integer, String> best = super.diffHelper(remainingFile1Index, remainingFile2Index);
			hashTable.put(currentPair, best);
			return best;
		}
	}
